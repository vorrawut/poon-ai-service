...
class CacheManager:
    ...
    def set_nlp_result(self, text: str, result: Any, language: str = "en", ttl: int = 3600) -> None:
        """Cache NLP result"""
        cache_key = f"nlp:{language}:{text}"
    ...
    def set_merchant_category(self, merchant: str, category: str, ttl: int = 86400) -> None:
